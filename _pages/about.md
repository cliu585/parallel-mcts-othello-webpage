# **Title:** Parallel Othello Solver with Monte Carlo Tree Search
...
3. Simulation: from the new node *C*, complete a full simulation of the game; that is, play the game out until the very end. Moves can be chosen as desired.   
...
4. Backpropagation: use the result of the played out game to update the information in the nodes from the root to *C*.   
